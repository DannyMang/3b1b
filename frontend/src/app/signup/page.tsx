...
export default function SignUpPage() {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!supabase || !tosAccepted) return;
            ...
            <form onSubmit={handleSignUp} className="w-full flex flex-col gap-3">
              ...
              <div className="flex items-center gap-2 mt-2">
                <input
                  ...
                  required
                />
                <label htmlFor="tos" className="text-xs text-neutral-400">
                  Agree to our <a href="#" className="underline">Terms of Service</a> and <a href="#" className="underline">Privacy Policy</a>
                </label>
              </div>
              <button
                type="submit"
                disabled={loading || !tosAccepted}
                className="w-full py-2 mt-2 rounded-lg bg-white text-black font-semibold hover:bg-neutral-200 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
